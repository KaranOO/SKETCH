...
const Products = () => {
    ...
    console.log("Here starts subcats");
    ...
    return (
        <div className="products">
            ...
            <div className="right">
                <img className='catImg' src="https://images.pexels.com/photos/206359/pexels-photo-206359.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
